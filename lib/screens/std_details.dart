import 'package:attendancehussain/database/Helper_db.dart';
import 'package:attendancehussain/model/student.dart';
...
class Students extends State<StudentDetail> {
  ...
  static var _status = ["Attendant", "Absent"];
  String screenTitle;
  Student student;
